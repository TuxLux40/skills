...
Agent skills by [TuxLux40](https://github.com/TuxLux40). One repo you can add as a marketplace in **Claude Code**, **Grok**, **Cursor**, **Codex**, and any other harness that understands the [Agent Skills](https://agentskills.io) layout.
